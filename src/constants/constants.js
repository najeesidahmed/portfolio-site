export const projects = [
  ...
  },
  {
    ...
    description: "Using React, I built a to do list with functionality to cross out completed tasks, and edit and update existing tasks",
...
export const data = [
  { number: 2, text: 'Years of HTML/CSS Experience'},
  { number: 10, text: 'Caps for England in International Karate', },
  { number: 85, text: 'Avergage in University Modules', },
  { number: 100, text: 'T-shirt Designs for my brand', }
];